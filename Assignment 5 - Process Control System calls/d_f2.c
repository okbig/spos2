...
*************** This is child process ***************
	 ...
	 My process id is : 2640
	 My Parent process id is : 2639
*************Child process terminates ***************


	 Parent process resumed after the execution of child process with PID 2640
	 My process id is : 2639
	 My Parent process id is : 2619
*/
